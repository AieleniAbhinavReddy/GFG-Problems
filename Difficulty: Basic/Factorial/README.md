<h2><a href="https://www.geeksforgeeks.org/problems/factorial5739/1?page=1&difficulty=Basic&status=unsolved,attempted&sortBy=submissions">Factorial</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a positive integer, <strong>n</strong>. Find the factorial of <strong>n</strong>.</span></p>
