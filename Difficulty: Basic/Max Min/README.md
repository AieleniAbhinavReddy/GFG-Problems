<h2><a href="https://www.geeksforgeeks.org/problems/max-min/1?page=1&difficulty=Basic&status=unsolved,attempted&sortBy=submissions">Max Min</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an array<strong> A</strong> of size <strong>N</strong> of integers. Your task is to find the sum of&nbsp;<strong>minimum and maximum </strong>element&nbsp;in the&nbsp;array.</span></p>
